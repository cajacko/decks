  ...
  return (
    <View style={style}>
      ...
      <ScrollView
        ...
        snapToInterval={state.stackWidth + 10}
      ...
      >
        {state.stackIds.map((stackId) => (
          <Stack
            key={stackId}
            stackId={stackId}
            style={{ paddingHorizontal: state.spaceBetweenStacks / 2 }}
            leftStackId={state.stackIds[state.stackIds.indexOf(stackId) - 1]}
            rightStackId={state.stackIds[state.stackIds.indexOf(stackId) + 1]}
