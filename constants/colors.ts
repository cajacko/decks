...
export const themes = {
  light: {
    ...
    skeletonPulse: Color(lightBackground).darken(0.2).rgb().string(),
    skeletonCard: lightBackground,
    skeletonCardPulse: Color(lightBackground).darken(0.1).rgb().string(),
  ...
  dark: {
    ...
    skeleton: Color(colors.black).lighten(1).rgb().string(),
    skeletonPulse: Color(colors.black).lighten(0.5).rgb().string(),
    skeletonCard: lightBackground,
    skeletonCardPulse: Color(lightBackground).darken(0.1).rgb().string(),
